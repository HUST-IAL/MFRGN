...
class Configuration:
    ...
    # Dataset
    data_folder = "/mnt/wangyuntao/Datasets/CVACT"     
    
    # Checkpoint to start from
    checkpoint_start = '/mnt/wangyuntao/ACMMM2024-results/weights/weights_cvact.pth'   
...
if __name__ == '__main__':
    ...
    # reference_dataloader_test = DataLoaderX(reference_dataset_test,
    #                                        batch_size=config.batch_size,
    #                                        num_workers=config.num_workers,
    #                                        shuffle=False,
    #                                        pin_memory=True)
    ...
    # query_dataloader_test = DataLoaderX(query_dataset_test,
    #                                    batch_size=config.batch_size,
    #                                    num_workers=config.num_workers,
    #                                    shuffle=False,
    #                                    pin_memory=True)
