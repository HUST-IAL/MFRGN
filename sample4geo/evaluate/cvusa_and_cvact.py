...
def evaluate(config,
    ...
    # print('reference_features:', reference_features.shape)
    # print('Max memery: ', torch.cuda.max_memory_allocated(torch.cuda.current_device())/1024**2)
